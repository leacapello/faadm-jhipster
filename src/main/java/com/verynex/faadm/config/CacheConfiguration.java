package com.verynex.faadm.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.verynex.faadm.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.verynex.faadm.repository.UserRepository.USERS_BY_EMAIL_CACHE);
