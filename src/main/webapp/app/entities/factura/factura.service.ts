...
export class FacturaService {
  ...
  protected convertDateFromClient(factura: IFactura): IFactura {
    const copy: IFactura = Object.assign({}, factura, {
      ...
      fechaVencimiento: factura.fechaVencimiento && factura.fechaVencimiento.isValid() ? factura.fechaVencimiento.toJSON() : undefined
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.fechaVencimiento = res.body.fechaVencimiento ? moment(res.body.fechaVencimiento) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((factura: IFactura) => {
        ...
        factura.fechaVencimiento = factura.fechaVencimiento ? moment(factura.fechaVencimiento) : undefined;
      });
    }
    return res;
  }
